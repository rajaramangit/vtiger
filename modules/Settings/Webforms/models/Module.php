...
class Settings_Webforms_Module_Model extends Settings_Vtiger_Module_Model {
	...
	public static function getSupportedModulesList() {
		return array('Leads' => vtranslate('Leads', 'Leads'),'Accounts' => vtranslate('Accounts', 'Accounts'),'Contacts' => vtranslate('Contacts', 'Contacts'));  //,'Contacts' => vtranslate('Contacts', 'Contacts') Rahul Change Add Contact Module in Webform 
	}
