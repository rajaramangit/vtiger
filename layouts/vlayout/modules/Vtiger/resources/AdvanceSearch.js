...
Vtiger_BasicSearch_Js("Vtiger_AdvanceSearch_Js",{
	...
	initiateSearch : function() {
		...
		var postLoad = function(uiData) {
			...
			uiData.closest('.blockMsg').position({
				my: "left bottom",
				at: "left bottom",
				of:"#mobileSearchValue", // "#globalSearchValue",
				offset: "1 -29"
			});
            aDeferred.resolve();
		}
	...
	search : function() {
        ...
        /**
         * Function which performs accounts mobile search only - modified by nanda
         */
        mobileAdvancedSearch : function(searchValue) {
                var params = {};
                params.module ="Accounts";
                params.advfilterlist = JSON.stringify({"1":{"columns":{"0":{"columnname":"vtiger_account:phone:phone:Accounts_Phone:V","comparator":"s","value"
:searchValue,"column_condition":""}}},"2":{"columns":{}}});
                this.elementContainer=jQuery("#advanceSearchContainer")[0];
                this.filterValidationRegistered=true;
                this.searchModule='Accounts';                
                return this._search(params);
        },
        
        performMobileSearch : function(searchValue) {
		var thisInstance = this;
		var isSearchResultsAndFilterShown = this.isSearchAndFilterComponentsShown();
		this.mobileAdvancedSearch(searchValue).then(function(data){
