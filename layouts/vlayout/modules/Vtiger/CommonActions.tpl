    ...
    <div class="navbar commonActionsContainer noprint">
        <div class="actionsContainer row-fluid">
            ...
            <div class="span10 marginLeftZero">
                <div class="row-fluid">
                    <div class="searchElement span2" style='display:none;'>
                    ...
                    <div class="searchElement span4">
                       <div class="select-search">
                            <select class="chzn-select" id="mobileSearchModulesList" style="width:150px;">
                                <option value="">Mobile Search</option>
                            </select>
                       </div>
                        <div class="input-append searchBar">
                            <input type="text" class="" id="mobileSearchValue" style=' border: 1px solid #dddddd;border-radius: 0 !important;height: 21px;margin-bottom: 0;min-width: 250px;' placeholder="{vtranslate('LBL_GLOBAL_SEARCH')}" results="10" />
                            <span id="mobileSearchIcon" class="add-on search-icon"><i class="icon-white icon-search "></i></span>
                            <span class="adv-search">
                                <a class="alignMiddle" id="globalSearch">{vtranslate('LBL_ADVANCE_SEARCH')}</a>
                            </span>
